#!/usr/bin/env python
# -*- coding: utf-8 -*-
# generated by wxGlade 0.6.3 on Wed Sep  9 23:15:55 2009
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
      # begin wxGlade: MyFrame.__init__
        ...
        self.other_op = wx.Panel(self.notebook_other_op, -1)
        ...
        self.sizer_15_staticbox = wx.StaticBox(self.audio_cd, -1, "Tracks to Burn")
        ...
        self.audio_burn_button = wx.BitmapButton(self.audio_cd_settings, -1, wx.Bitmap("/home/sayan/Desktop/fire-icon.png", wx.BITMAP_TYPE_ANY), style=wx.BU_AUTODRAW)
        ...
        self.data_adddir_button = wx.Button(self.data_cd, wx.ID_ADD, "")
        ...
        self.data_burn_button = wx.BitmapButton(self.data_cd_settings, -1, wx.Bitmap("/home/sayan/Desktop/fire-icon.png", wx.BITMAP_TYPE_ANY), style=wx.BU_AUTODRAW)
        ...
        self.dvd_adddir_button = wx.Button(self.data_dvd, wx.ID_ADD, "")
        ...
        self.dvd_burn_button = wx.BitmapButton(self.data_dvd_settings, -1, wx.Bitmap("/home/sayan/Desktop/fire-icon.png", wx.BITMAP_TYPE_ANY), style=wx.BU_AUTODRAW)
        self.panel_4_copy_copy = wx.Panel(self.data_dvd_settings, -1)
        self.label_device_1_copy = wx.StaticText(self.other_op, -1, "Target Device : ", style=wx.ST_NO_AUTORESIZE)
        self.format_device_list = wx.ComboBox(self.other_op, -1, choices=["/dev/cdrw", "/dev/cdrw1"], style=wx.CB_DROPDOWN)
        self.format_devprop_button = wx.Button(self.other_op, wx.ID_PROPERTIES, "")
        self.quickblankcd_button = wx.Button(self.other_op, -1, "Quick Blank CDRW")
        self.fullblankcd_button = wx.Button(self.other_op, -1, "Full Blank CDRW")
        self.formatdvd_button = wx.Button(self.other_op, -1, "Format DVDRW")
        self.justfixate_button = wx.Button(self.other_op, -1, "Just Fixate Disk")
        ...
        self.Bind(wx.EVT_BUTTON, self.OnQuickBlankCd, self.quickblankcd_button)
        self.Bind(wx.EVT_BUTTON, self.OnFullBlankCd, self.fullblankcd_button)
        self.Bind(wx.EVT_BUTTON, self.OnFormatDvd, self.formatdvd_button)
        self.Bind(wx.EVT_BUTTON, self.OnFixateDisk, self.justfixate_button)
        # end wxGlade
        il = wx.ImageList(48,48)
        img0 = il.Add(wx.Bitmap('/home/sayan/graveman-0.3.12-5/pixmaps/graver.png', wx.BITMAP_TYPE_PNG))        
    ...
    def __set_properties(self):
        ...
        self.audio_burn_button.SetToolTipString("Burn CD Now!")
        ...
        self.data_burn_button.SetToolTipString("Burn CD Now!")
        ...
        self.dvd_burn_button.SetToolTipString("Burn CD Now!")
        self.dvd_burn_button.SetDefault()
        self.format_device_list.SetSelection(-1)
        self.quickblankcd_button.SetMinSize((140, 32))
        self.fullblankcd_button.SetMinSize((132, 32))
        self.formatdvd_button.SetMinSize((132, 32))
        self.justfixate_button.SetMinSize((132, 32))
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer_18_copy_1 = wx.BoxSizer(wx.HORIZONTAL)
        ...
        sizer_13.Add(sizer_15, 1, wx.TOP|wx.EXPAND, 11)
        ...
        sizer_17.Add(self.quickblankcd_button, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        sizer_17.Add(self.fullblankcd_button, 0, wx.LEFT|wx.RIGHT, 7)
        sizer_17.Add(self.formatdvd_button, 0, wx.RIGHT, 7)
        sizer_17.Add(self.justfixate_button, 0, 0, 0)
        sizer_7_copy_copy_1.Add(sizer_17, 1, wx.LEFT|wx.RIGHT|wx.BOTTOM|wx.EXPAND, 13)
        sizer_6_copy_1.Add(sizer_7_copy_copy_1, 1, wx.EXPAND, 0)
        sizer_6_copy_1.Add(sizer_18_copy_1, 1, wx.EXPAND, 0)
        self.other_op.SetSizer(sizer_6_copy_1)
        self.notebook_other_op.AddPage(self.other_op, " Other Operations ")
